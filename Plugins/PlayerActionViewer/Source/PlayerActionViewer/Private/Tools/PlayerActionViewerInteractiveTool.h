...
#include "PlayerActionViewerInteractiveTool.generated.h"


/**
 * Builder for UPlayerActionViewerInteractiveTool
 */
UCLASS()
class PLAYERACTIONVIEWER_API UPlayerActionViewerInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UPlayerActionViewerInteractiveTool
 */
UCLASS(Transient)
class PLAYERACTIONVIEWER_API UPlayerActionViewerInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UPlayerActionViewerInteractiveToolProperties();
...
/**
 * UPlayerActionViewerInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class PLAYERACTIONVIEWER_API UPlayerActionViewerInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UPlayerActionViewerInteractiveToolProperties> Properties;
