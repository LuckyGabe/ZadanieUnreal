...
#include "PlayerActionViewerEditorMode.generated.h"
 ...
 */
UCLASS()
class UPlayerActionViewerEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_PlayerActionViewerEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UPlayerActionViewerEditorMode();
	virtual ~UPlayerActionViewerEditorMode();
